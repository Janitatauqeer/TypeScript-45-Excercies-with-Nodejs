...
if (alien_color_1 === 'green') {
    console.log("\nCongratulations! You shot down `Green Alien`, You just earned 5 points.");
} else if (alien_color_1 === 'yellow') {
    console.log("\nCongratulations! You shot down `Yellow Alien`, You just earned 10 points.");
} else if (alien_color_1 === 'red') {
    console.log("\nCongratulations! You shot down `Red Alien`, You just earned 15 points.");
}
